...
def main():
    dblp_path = '/Users/meetapandit/DE_Bootcamp/SQL_optimization_exercise/dblp.xml'
    try:
        ...
        exit()
    parse_article(dblp_path, '/Users/meetapandit/DE_Bootcamp/SQL_optimization_exercise/dataset/article.csv', save_to_csv=True)
    parse_publications(dblp_path, '/Users/meetapandit/DE_Bootcamp/SQL_optimization_exercise/dataset/publications.csv', save_to_csv=True)
    parse_book(dblp_path, '/Users/meetapandit/DE_Bootcamp/SQL_optimization_exercise/dataset/book.csv', save_to_csv=True)
    parse_proceedings(dblp_path, '/Users/meetapandit/DE_Bootcamp/SQL_optimization_exercise/dataset/proceedings.csv', save_to_csv=True)
    parse_inproceedings(dblp_path, '/Users/meetapandit/DE_Bootcamp/SQL_optimization_exercise/dataset/inproceedings.csv', save_to_csv=True)
    parse_author(dblp_path, '/Users/meetapandit/DE_Bootcamp/SQL_optimization_exercise/dataset/author.csv', save_to_csv=True)
